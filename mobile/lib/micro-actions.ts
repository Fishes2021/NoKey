...
export type MicroActionId = ProgrammableCommandId | 'microdex.insertPrompt' | 'voicedeck.shortcut';
...
export const MICRO_ACTIONS: readonly MicroAction[] = [
  {
    id: 'voicedeck.shortcut',
    label: 'Mac 通用快捷键',
    description: '配置组合键，发送至显示的 Mac 前台应用。',
    category: 'Input',
  ...
  },
  {
    ...
    label: '手机麦克风',
    description: '点击开始实时传音到 Mac 虚拟麦克风，再点停止；无需按住。',
    category: 'Input',
