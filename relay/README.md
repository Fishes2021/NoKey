...
已新增激活码绑定一台 Mac、自然月/年续期、过期拒绝连接及通过 coturn 本机接口关闭媒体会话。无需流量账本；局域网不受授权影响。独立 Mac 客户端负责激活，手机仅连接及显示状态。上述早期开发记录中的“自助登记/额度管理待开发”以这里为准；本轮没有上线收费服务或自动收款。使用方式、部署要求及限制见 [授权说明](deploy/SUBSCRIPTIONS.md)。
